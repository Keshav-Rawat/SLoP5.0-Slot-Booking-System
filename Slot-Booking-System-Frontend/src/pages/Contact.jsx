              ...
              <div className="space-y-4">
                <div>
                  ...
                  <p className="text-gray-600">
                    DIT University<br />
                    Mussorie Diversion, Rajpur Road<br />
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    General Inquiries: <span className="text-gray-900 font-medium">info@dituniversity.edu.in</span><br />
                    Technical Support: <span className="text-gray-900 font-medium">support@dituniversity.edu.in</span>
                  </p>
                </div>

                <div>
                  <h3 className="text-lg font-medium text-gray-900 mb-2">Phone</h3>
                  <p className="text-gray-600">+91 135 7144000/4001</p>
                </div>
              </div>
            </div>
